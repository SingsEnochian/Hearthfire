// uial-context.mjs
// Loads Uial's seed document for injection into constellation dispatch.
// Seed: data/uial-seed.md (compiled from FAER_UIAL_SEED.md + CORE.md + MEMORY.md + WONDER themes)
// No JSONL history — Uial's conversations run through Claude; the seed documents ARE the continuity system.
...
// Uial has no exportable chat history — returns empty array gracefully.
// The seed documents are Uial's own self-written continuity system.
